...
class MainActivity : AppCompatActivity() {
    ...
    private fun rotater() {
        val animator: ObjectAnimator = ObjectAnimator.ofFloat(star, View.ROTATION,
        -360f, 0f)
    ...
    private fun shower() {
        ...
        var starH: Float = star.width.toFloat()
        ...
        val mover = ObjectAnimator.ofFloat(newStar,
        View.TRANSLATION_Y, -starH, containerH + starH)
        mover.interpolator = AccelerateInterpolator(1f)

        val rotator = ObjectAnimator.ofFloat(newStar,
